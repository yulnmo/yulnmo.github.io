const Sakura = function(selector, options) {
    ...
    const defaults = {
      ...
      fallSpeed: 1.5, // Speed factor in which the petal falls (higher is slower).
      maxSize: 12, // The maximum size of the petal.
      minSize: 8, // The minimum size of the petal.
      delay: 1200, // Delay between petals.
      colors: [
        /*
        {
        ...
        */
        ...
        {
            // You can add multiple colors (chosen randomly) by adding elements to the array.
            gradientColorStart: 'rgba(183, 255, 197, 0.9)', // Gradient color start (rgba).
            gradientColorEnd: 'rgba(197, 255, 208, 0.9)', // Gradient color end (rgba).
            gradientColorDegree: 120, // Gradient degree angle.
        },
        */
        {
            // You can add multiple colors (chosen randomly) by adding elements to the array.
            gradientColorStart: 'rgba(255, 255, 197, 0.9)', // Gradient color start (rgba).
            gradientColorEnd: 'rgba(255, 255, 208, 0.9)', // Gradient color end (rgba).
            gradientColorDegree: 120, // Gradient degree angle.
        },
      ],
    };
